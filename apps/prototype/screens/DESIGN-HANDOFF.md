...
This archive is the source of truth for turning the design into production code. Start from `ask-evi.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `ask-evi.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `ask-evi.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `doc-blood-test.html`
- `doc-lifestyle.html`
- `doc-physical-health.html`
- `doc-questionnaire.html`
- `doc-upload-viewer.html`
- `documents.html`
- `faq.html`
- `insights.html`
- `login.html`
...
1. Inspect `ask-evi.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
