...
</div></a><div class="menu-items-wrapper"><nav role="navigation" class="div-navbar__menu w-nav-menu"><a href="/how-it-works" class="nav-link-3 w-nav-link">How it works</a><a href="/membership" class="nav-link-3 w-nav-link">Membership</a><a href="/posts" class="nav-link-3 w-nav-link">Blog</a><a href="/about-us" class="nav-link-3 w-nav-link">About us</a><a href="/contact-us" aria-current="page" class="nav-link-3 w-nav-link w--current">Contact us</a></nav></div><div class="w-layout-blockcontainer link-block-2 w-container"><a href="#hubspot-contactus-form" class="global-button w-variant-62f42df2-6780-9e0b-4407-658c8b7f8080 w-button">Get in touch</a></div><div class="div-navbar__burger w-nav-button"><div class="code-embed-3 w-embed"><svg class="nav-burger" width="24" height="18" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0.5 5.5H13.8333M0.5 0.5H13.8333M0.5 10.5H13.8333" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"/>
</svg></div></div><div class="w-embed"></div></div></div></div></section>

<section style="background:#09332e; padding:140px 40px 80px; display:flex; align-items:flex-end;">
...
<section style="background:#fefbe7; padding:100px 40px;">
  <div style="max-width:1280px; margin:0 auto; display:flex; flex-wrap:wrap; gap:80px; align-items:start;">

    <div style="flex:1; min-width:260px; max-width:380px;">
      <h2 style="font-family:Geist,sans-serif; font-size:26px; font-weight:400; color:#09332e; margin:0 0 28px; line-height:1.2;">How to reach us</h2>

      <div style="background:white; border:1px solid rgba(26,85,93,0.14); border-radius:12px; padding:24px 28px; margin-bottom:12px;">
        <span style="font-family:Inter,sans-serif; font-size:11px; font-weight:600; letter-spacing:0.1em; text-transform:uppercase; color:#ff5a5f; display:block; margin-bottom:8px;">Email</span>
        <a href="mailto:hello@evida.uk" style="font-family:Geist,sans-serif; font-size:20px; color:#09332e; text-decoration:none; display:block; margin-bottom:4px;">hello@evida.uk</a>
        <span style="font-family:Inter,sans-serif; font-size:13px; color:#575757; line-height:1.4;">We reply within 24 hours on weekdays.</span>
      </div>

      <div style="background:white; border:1px solid rgba(26,85,93,0.14); border-radius:12px; padding:24px 28px; margin-bottom:12px;">
        <span style="font-family:Inter,sans-serif; font-size:11px; font-weight:600; letter-spacing:0.1em; text-transform:uppercase; color:#ff5a5f; display:block; margin-bottom:8px;">Office</span>
        <address style="font-family:Geist,sans-serif; font-size:16px; color:#09332e; font-style:normal; line-height:1.7; margin:0;">71–75 Shelton Street<br>Covent Garden, London<br>WC2H 9JQ</address>
      </div>
    ...
    <div style="flex:1.5; min-width:300px;">
      <h2 style="font-family:Geist,sans-serif; font-size:26px; font-weight:400; color:#09332e; margin:0 0 28px; line-height:1.2;">Send us a message</h2>
      <div id="hubspot-contactus-form" style="background:white; border:1px solid rgba(26,85,93,0.14); border-radius:16px; padding:40px; min-height:220px;">
        <h3 class="heading" style="margin-top:0; font-family:Geist,sans-serif; font-size:20px; font-weight:400; color:#09332e;">Your Details</h3>
      </div>
    </div>
...
<section class="footer-footer"><div class="boxed-container-2"><div class="div-footer"><div class="div-footer-top"><div class="div-footer-newsletter"><div class="div-footer-logo-mobile"><a href="/" class="w-inline-block"><img src="/assets/69cb2ba27042ece99a236722/69cb98b5235358c0cf7a7159_Group-273.svg" loading="lazy" alt="" class="img-footer-logo__img"/></a></div><div class="h3-footer-newsletter__heading"><h3 class="span-footer-newsletter__regular">Subscribe to our</h3><h3 class="em-footer-newsletter__italic">newsletters</h3></div><div class="form-footer-newsletter__form"><div class="form-block w-form"><form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-4" data-wf-page-id="69cbe06033588d805b80e6f0" data-wf-element-id="b2f73c00-99c2-041a-7473-e5b4ff7641e8" data-turnstile-sitekey="0x4AAAAAAAQTptj2So4dx43e"><input class="text-field-copy w-input" maxlength="256" name="email" data-name="Email" placeholder="Your email address" type="email" id="email" required=""/><input type="submit" data-wait="Please wait..." class="button-sleek-3 w-button" value="Submit"/></form><div class="w-form-done"><div>Thank you! Your submission has been received!</div></div><div class="w-form-fail"><div>Oops! Something went wrong while submitting the form.</div></div></div></div></div><div class="w-layout-hflex flex-block-8"><div class="div-footer-nav"><div class="p-footer-nav__label">EXPLORE</div><a href="/how-it-works" class="a-footer-nav__link">How it works</a><a href="/membership" class="a-footer-nav__link">Membership</a><a href="/about-us" class="a-footer-nav__link">About us</a><a href="/posts" class="a-footer-nav__link">Blog</a><a href="/contact-us" aria-current="page" class="a-footer-nav__link w--current">Contact us</a></div><div class="div-footer-contact"><div class="p-footer-contact__label">CONTACT US</div><a href="mailto:hello@evida.uk" class="a-footer-contact__email">hello@evida.uk</a><div class="p-footer-contact__address">71-75 Shelton Street, Covent Garden, London, WC2H 9JQ</div></div><div class="div-footer-logo"><a href="/" class="w-inline-block"><img src="/assets/69cb2ba27042ece99a236722/69cb98b5235358c0cf7a7159_Group-273.svg" loading="lazy" alt="" class="img-footer-logo__img"/></a></div></div></div><div class="div-footer-bottom"><div class="div-footer-social"><a href="https://www.instagram.com/evida.health" target="_blank" class="a-footer-social__link w-inline-block"><img src="/assets/69cb2ba27042ece99a236722/69d7d369b6c327122635f1f0_Instagram.svg" loading="lazy" alt=""/></a><a href="https://www.linkedin.com/company/evidahealth/" target="_blank" class="a-footer-social__link w-inline-block"><img src="/assets/69cb2ba27042ece99a236722/69d7d3682aeb121430245d74_Linkedin.svg" loading="lazy" alt=""/></a><a href="https://evidahealth.substack.com/" target="_blank" class="a-footer-social__link w-inline-block"><img src="/assets/69cb2ba27042ece99a236722/69d7d110b1c6100deddabbc2_substack.svg" loading="lazy" alt=""/></a></div><div class="w-layout-hflex flex-block-7"><div class="div-footer-legal"><a href="/privacy-policy" class="a-footer-legal__link">Privacy Policy</a></div><div class="p-footer-copyright">© 2026 Evida — Copyright</div></div></div></div></div></section>
`

export default function Content() {
  return <PageClient html={PAGE_HTML} scripts={SHARED_SCRIPT_QUEUE} />;
}
